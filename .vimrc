...
au! BufRead,BufNewFile *.snippet set filetype=xml

set guifont=DejaVu_Sans_Mono:h10:cANSI

au BufRead,BufNewFile *.wiki                set filetype=mediawiki
au BufRead,BufNewFile *6ym955j*             set filetype=mediawiki
...
set backupdir=.\\.backup,.,\\tmp,c:\\temp
set directory=.\\.backup,\\tmp,c:\\temp

au FileType xml setlocal equalprg=xmllint\ --format\ --recover\ -\ 2>/dev/null
au FileType xml setlocal shiftwidth=2
au FileType xml setlocal tabstop=2
au FileType xml setlocal softtabstop=2
...
"set tag=C:\Users\jamesc\Code\WOMS\tags
